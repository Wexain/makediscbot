...
[![PyPI version](https://badge.fury.io/py/makediscbot.svg)](https://badge.fury.io/py/makediscbot)
[![Python 3.8+](https://img.shields.io/badge/python-3.8+-blue.svg)](https://www.python.org/downloads/)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

Are you tired of rewriting the same basic bot code? Struggling to figure out how discord.py Buttons, Modals, and Dropdowns work? 

**MakeDiscBot** is a CLI tool that instantly generates a massive, 1,600+ line `make_a_bot.py` template file containing **over 100 commands**, a full economy database, ticket systems, and every UI component imaginable. It is the ultimate copy-paste cheat sheet for Discord bot developers.

## ⚡ Installation

Install the package globally via pip:
``bash``
``pip install makediscbot``

``🛠️ Usage``
Navigate to the folder where you want to build your bot, and run:

``bash``
python -m makebot.cli
BOOM! 💥 A file named make_a_bot.py will appear in your directory. Open it, paste your bot token at the bottom, and you have a fully functioning, highly advanced Discord bot ready to run.

You also have the code here so just copy it and paste it wherever you want.
...
Ethereum (ETH): 0x2AF7de0a3D630E2e4fc27E02a1F3c3C2D198FA08

``Check the code for trust, and this is for donation this is not required makediscbot is a free code file.``
